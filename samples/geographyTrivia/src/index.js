...
var questions = [
    ...
    {
        "Japan has the highest life expectancy in the world. Which country is second in terms of life expectancy?": [
            "Switzerland",
            "Singapore",
            "Australia",
            "Denmark"
    ...
    {
        "China has got the most people in the world. Which country is second in terms of population?": [
            "India",
            "America",
            "Indonesia",
            "Brazil"
    ...
    {
        "Which grain is the most eaten food in the world?": [
            "Rice",
            "Wheat",
            "Corn",
            "Oats"
...
exports.handler = function (event, context) {
    ...
    if (event.session.application.applicationId !== "amzn1.echo-sdk-ams.app.1ca0679c-d1cb-44f7-b25f-6a04830f8799") {
